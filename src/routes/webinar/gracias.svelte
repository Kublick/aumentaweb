...
<div class="flex flex-col h-screen justify-center align-middle bg-transparent">
	<div class="grid lg:grid-cols-4 bg-transparent min-h-[720px] items-center">
		<div class="hidden py-24 md:bg-gradient-to-r from-primary  to-white lg:grid container ">
		...
		<div class="col-span-3 md:mx-24 mx-4 my-12">
			...
			<div class="flex justify-center gap-4 align-middle items-center ">
				<div
					class="rounded-full  bg-whatsapp px-6 text-2xl font-bold text-white shadow-lg flex gap-4 py-4 my-12 hover:opacity-95"
				>
					<span class="h-8 w-8">
						<svg
					...
					<button
						class="font-bold text-sm lg:text-2xl disabled:cursor-not-allowed"
						on:click={() => {
